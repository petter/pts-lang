...
var Scope = /** @class */ (function () {
    ...
    Scope.prototype.lookup = function (name) {
        var _a;
        return this.variables.find(function (v) { return v.origName === name; })
            || ((_a = this.parentScope) === null || _a === void 0 ? void 0 : _a.lookup(name));
    };
    Scope.prototype.lookupClass = function (name) {
        var _a;
        return this.classes.find(function (c) { return c.origName === name; })
    ...
    Scope.prototype.toString = function () {
        return this.variables.map(function (v) { var _a; return v.name + ': ' + ((_a = v.instanceOf) === null || _a === void 0 ? void 0 : _a.name); }).join('\n');
    };
    return Scope;
}());

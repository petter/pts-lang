...
function transform(node, transformer) {
    if (Array.isArray(node)) {
        return node.map(function (inp) { return transform(inp, transformer); });
    }
    var transformerObj = typeof transformer === 'object' ? transformer : transformer(function (inp) { return transform(inp, transformer); });

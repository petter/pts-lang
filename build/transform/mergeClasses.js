...
var classDeclId = function (cld) { return cld.children.find(function (el) { return el.type === 'type_identifier'; }).text; };
...
function replaceClassDeclsWithMergedClasses(body, mergedClasses) {
    ...
    return index_1.default(body, {
        class_declaration: function (node, children) {
            ...
            hasVisited.push(id);
            var mergedClass = mergedClasses.find(function (el) { return classDeclId(el) === id; });

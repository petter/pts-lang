...
function toTS(program) {
    var unformatted = transform_1.default(program, {
        ...
        package_declaration: function (_, children) {
            return children.slice(2).join('');
        },
        package_template_body: function (_, children) {
            return children.slice(1, -1).join('\n');
        },
        member_expression: function (_, children) {
            return children.join('');
        },
        program: function (_, children) {
            return children.join('\n');
        },
        class_body: function (_, children) {
            return children.join('\n');
        },
        statement_block: function (_, children) {
            return children.join('\n');
        },
        string: function (node, _) {
            return node.text;
        },

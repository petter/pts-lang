...
function getTemplates(program) {
    function isClosed(body) {
        return !body.some(function (child) {
            return child.type === 'inst_statement';
        });
    }
    var templates = [];
    var findTemplatesTransform = {
        template_declaration: function (node, children) {
            var _a, _b;
            var identifier =
                ((_a = findByType(children, 'identifier')) === null || _a === void 0 ? void 0 : _a.text) || '';
            var body =
                ((_b = findByType(children, 'package_template_body')) === null || _b === void 0
                    ? void 0
                    : _b.children.slice(1, -1)) || [];
            templates.push({ identifier: identifier, body: body, isClosed: isClosed(body) });
...
var findByType = function (children, type) {
    return children.find(_1.typeIs(type));
};
